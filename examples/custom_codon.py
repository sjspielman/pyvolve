...
# Define a codon model, as a Model object. Below are several example dictionaries of customized parameters. Note that any unspecified parameters remain the default value. Further, for codon models, dN/dS is always required!
...
my_model = Model("nucleotide", parameters3) # Any of the dictionaries shown above is acceptable!
