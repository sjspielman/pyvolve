...
# Define a nucleotide model, as a Model object. Below are several example dictionaries of customized parameters. Note that any unspecified parameters remain the default value.
