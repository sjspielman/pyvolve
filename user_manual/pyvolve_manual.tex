...
Pyvolve models site-rate heterogeneity discretely, using either a discrete gamma distribution or a user-specified discrete rate distribution. Rate heterogeneity is incorporated into a \code{Model} object with several additional keyword arguments, detailed below. Note that, if you would like to specify a proportion of invariant sites (\code{+I}), simply set one of the rate factors to 0 and assign it a corresponding probability as usual.
